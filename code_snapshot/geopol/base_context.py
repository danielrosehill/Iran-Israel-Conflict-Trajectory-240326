"""Static base context about the Iran-Israel-US conflict.

Ported verbatim from the original TS POC (`src/lib/base-context.ts`).
"""

BASE_CONTEXT = """## CONFLICT BACKGROUND & KEY FACTS
